...
export const PRODUCT_IMAGE_DROP_BUTTON_CLASS = `${PRODUCT_IMAGE_TILE_SIZE_CLASS} grid cursor-pointer place-items-center rounded-xl border-2 border-dashed border-slate-300 bg-white p-5 text-center transition hover:bg-[var(--brand-primary-soft)]`;
