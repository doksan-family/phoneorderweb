  ...
  return (
    <div className="rounded-2xl bg-slate-100 p-[18px]">
      <div className="flex flex-wrap items-baseline justify-end gap-x-2 gap-y-1">
        ...
        <strong className="text-right text-[1.65rem] font-extrabold tracking-[-0.02em] text-slate-950">
          {product.releasePrice.toLocaleString("ko-KR")}원
        </strong>
      </div>
      {product.monthlyEstimate > 0 ? (
        <p className="m-0 mt-1 text-right text-[0.85rem] font-bold text-[var(--brand-primary-strong)]">
